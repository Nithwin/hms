...
import mahe from '../../images/mahe2.jpg'

export default function About(){
  return( <section className="card-container bg-[#210643] h-screen m-2 rounded overflow-hidden justify-center items-center flex pb-20 ps-20 gap-32">
...
//       <p className="font-semibold text-teal-600">Frontend &  </p>
...
//   <div className="card px-5 py-5 bg-gradient-to-r from-blue-500 to-violet-500 rounded  shadow-black shadow-lg ">
//     <div className="bg-black rounded-full p-2 transition duration-500 hover:scale-110">
//       <img src={raju} alt="" className="h-48 rounded-full" />
//     </div>
...
//   <div className="card px-5 py-5 bg-gradient-to-r from-blue-500 to-violet-500 rounded  shadow-black shadow-lg ">
//     <div className="bg-black rounded-full p-2 transition duration-500 hover:scale-110">
//       <img src={mahe} alt="" className="h-48  rounded-full " />
//     </div>
//     <div className="bg-black text-white px-4 py-3 rounded-md mt-5 border-[#f42746] border-2 transition duration-500 hover:scale-110">
