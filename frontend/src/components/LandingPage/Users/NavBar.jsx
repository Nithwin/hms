...
export default function NavBar (){
  return(
    <nav className='flex justify-between font-bold text-white bg-[#020f39] px-10 py-4 items-center m-2 rounded-lg'>
    ...
    <div className="flex space-x-5 items-center text-xl ">
      ...
      <NavLink to="/adim" className="px-5 py-3 rounded hover:bg-slate-50 hover:text-gray-950 transition-all ease-linear hover:delay-75" >Adim</NavLink>
